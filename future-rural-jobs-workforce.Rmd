...
Again, it's worth mentioning here but occupation groups such as production and farming, fishing and forestry may be facing shortages in the future. And one of the big reasons they are currently facing surpluses is because of the season in which the current unemployment data was pulled.
...
# Which EDRs will see transition from workforce surpluses to shortages and vice-versa?

The table below provides the number of occupation groups that will experience each type of transition category for each EDR.
...
names(num.occ.group.transition.category.table)
```


# Not done yet here{.tabset}
