...
The table below provides each occupation group that had a workforce shortage or a workforce surplus throughout the month of October. What you will find is that the major disruptions the pandemic has had to certain industries has impacted occupations with a skill set that don't necessarily align with occupations that are still hiring. For the most part, the pandemic has impacted low-wage and low-skill occupations while not necessarily disrupting industries that require higher skills. Other occupations that are experiencing significant workforce surpluses are typically "seasonal" such as construction and extraction, farming fishing and forestry, and building & grounds cleaning and maintenance.  This leaves  employers attempting to engage an unemployment pool that may require significant retraining.



Prominent occupations with workforce surpluses that are more seasonal in nature
* Construction and extraction
* Farming, fishing and forestry
* Building & grounds cleaning & maintenance
* Production

Prominent occupations with workforce surpluses likely impacted by the pandemic
